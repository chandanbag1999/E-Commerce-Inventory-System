...
public record SubmitPurchaseOrderCommand(Guid PurchaseOrderId) : IRequest<Result<PurchaseOrderDto>>;

public class SubmitPurchaseOrderCommandHandler : IRequestHandler<SubmitPurchaseOrderCommand, Result<PurchaseOrderDto>>
{
    ...
    public async Task<Result<PurchaseOrderDto>> Handle(SubmitPurchaseOrderCommand request, CancellationToken ct)
    {
        ...
        return Result<PurchaseOrderDto>.SuccessResult(dto, "Purchase order submitted");
    }
