...
namespace EIVMS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260411183204_AddNotificationsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EIVMS.Domain.Entities.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EIVMS.Domain.Entities.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EIVMS.Domain.Entities.Payments.PaymentAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EIVMS.Domain.Entities.Payments.Refund", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EIVMS.Domain.Entities.Payments.PaymentAttempt", b =>
                {
                    b.HasOne("EIVMS.Domain.Entities.Payments.Payment", "Payment")
                        .WithMany("Attempts")
